...
CREATE UNIQUE INDEX IF NOT EXISTS "ClassLabel_branchId_name_key" ON "public"."ClassLabel"("branchId", "name");
...
CREATE UNIQUE INDEX IF NOT EXISTS "Subject_classId_name_key" ON "public"."Subject"("classId", "name");
