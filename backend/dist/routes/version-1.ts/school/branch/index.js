...
import { createClassName, createFaculty, createOrUpdateClass, createSection, createSubject, deleteSection, deleteSubject, getAllClass, getAllSections, getClassNames, getFaculty, getSubjects, updateFaculty, updateSection, updateSubject, } from "@src/controllers/school/class/index.js";
import { createCustomFields, createSchool, deleteSchool, editSchool, getBranches, getCustomFields, getSchools, } from "@src/controllers/school/school/index.js";
