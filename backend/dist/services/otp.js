...
//   }
// };
export const sendOtpEmailFunction = async (email, type) => {
    try {
        const otp = generateOtp(email, type);
...
//   }
// }
export const emailVerification = async (otp, email, type) => {
    let receivedOtp = otp;
    let userId = email;
    try {
