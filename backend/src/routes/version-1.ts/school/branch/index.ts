...
import { createSchool, getBranches, getSchools, deleteSchool, editSchool, createCustomFields, getCustomFields } from "@src/controllers/school/school/index.js";
import { isPermitted } from "@src/middlewares/permission/index.js";
import multer from "multer";
import { createSubject, createOrUpdateClass, createSection, getAllClass, getAllSections, deleteSection, updateSection, getClassNames, createClassName, createFaculty, getFaculty, getSubjects, deleteSubject, updateSubject, updateFaculty } from "@src/controllers/school/class/index.js";
