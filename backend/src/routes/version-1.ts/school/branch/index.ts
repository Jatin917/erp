...
branchRouter.post("/create-section", requirePermission(Permission.CREATE_SECTION), createSection);
branchRouter.patch("/update-section", requirePermission(Permission.EDIT_SECTION), updateSection);
branchRouter.delete("/delete-section", requirePermission(Permission.DELETE_SECTION), deleteSection);
branchRouter.get("/get-section", requirePermission(Permission.VIEW_SECTION), getAllSections);
...
branchRouter.patch("/update-subject", requirePermission(Permission.EDIT_SUBJECT), updateSubject);
